...
public class SolventDropLiposome : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Time.time - startTime >= 24.25f && Time.time - startTime <= 25.5f)
        {
            solvent29.SetActive(true);
            solvent30.SetActive(true);
        }
        if (Time.time - startTime >= 25.5f && Time.time - startTime <= 26.75f)
        {
            solvent31.SetActive(true);
            solvent32.SetActive(true);
        }
        if (Time.time - startTime >= 26.75f && Time.time - startTime <= 28)
        {
            solvent33.SetActive(true);
            solvent34.SetActive(true);
        }
        if (Time.time - startTime >= 28 && Time.time - startTime <= 29.25f)
        {
            solvent35.SetActive(true);
            solvent36.SetActive(true);
        }
        if (Time.time - startTime >= 29.25f && Time.time - startTime <= 30.5f)
        {
            solvent37.SetActive(true);
            solvent38.SetActive(true);
        }
        if (Time.time - startTime >= 30.5f && Time.time - startTime <= 31.75f)
        {
            solvent39.SetActive(true);
            solvent40.SetActive(true);
        }
        if (Time.time - startTime >= 31.75f && Time.time - startTime <= 33)
        {
