...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        ///////////////////////////////////////////////////
        /////////laser lasers raycast raycasting //////////
        ///////////////////////////////////////////////////
        ...
        // Keep track of times item is grabbed
        ...
        private const int ColliderArraySize = 32; //was 16
        ...
        float GetBeamLength(bool bHit, RaycastHit hit)
        {
            ...
            if (bHit)
            {
                ...
                //Debug.Log("TOUCHING " + hit.transform);
            }
        ...
        protected virtual void UpdateHovering()
        {
            ...
            Ray raycast = new Ray(transform.position, transform.TransformDirection(Vector3.forward) * 10);
            ...
            if (useControllerHoverComponent && mainRenderModel != null && mainRenderModel.IsControllerVisibile())
            {
                ...
                CheckHoveringForTransform(hitObject.point, scaledHoverRadius / 2f, ref closestDistance, ref closestInteractable, Color.blue);
            }
        ...
        protected virtual bool CheckHoveringForTransform(Vector3 hoverPosition, float hoverRadius, ref float closestDistance, ref Interactable closestInteractable, Color debugColor)
        {
            ...
            //Check point of raycast collision
            //Hover Hovering
            //This is to check hovering at the start of scene 1 and enabling the line 1 to be played

            if (numColliding > 0 && hitObject.collider != null)
            {

                if (hitObject.collider.name == "disableStart")
                {

                    timestart += Time.deltaTime;
                    if (timestart >= .1)
                    {
                        disableStart.gameObject.SetActive(false);

                        ///////////////////////////////////D I S A B L E D///////////////////////
                        ///
                        //playAudio.beginScene1 = true;
                        //DialogueTrigger.hoverStart = true;
        ...
        private void Destroy(object gameStart, int v)
        {
            throw new NotImplementedException();
        }

        private void Destroy(string v1, int v2)
        {
            throw new NotImplementedException();
        }
        ...
        public GrabTypes GetGrabStarting(GrabTypes explicitType = GrabTypes.None)
        {
            if (explicitType != GrabTypes.None)
            {
                ...
                ///////////// Comment out to prevent grabbing with palm trigger if implemented//////////////
